...
def get_parser():
    ...
    parser.add_argument('--randomize', action='store_true', help = 'Enable random parameter sampling from config ranges')
    parser.add_argument('--seed', type = int, default=None, help = 'Random seed for reproducibility (used with --randomize)')
